...
class AdvertisementForm(forms.Form):
    ...
    description = forms.CharField(widget=forms.Textarea(attrs={'class':'form-control form-control-lg'}))    # widget - помогает правильно настроить поле: высота, ширина, особый стиль и т.д. 
    ...
    )                                                          # required=False - это поле можно пропустить при заполнении
